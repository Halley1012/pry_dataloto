...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG Melate ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - Melate</h3>
...
with DAG(
    ...
    schedule='0 3 * * 1,4,6', # Lunes, Jueves y Sábados a las 3:00 AM (tras sorteos de Dom, Mié y Vie)
