...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG Powerball ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver

    html = """
    <h3>Ejecución de Powerball finalizada con éxito</h3>
    <p>El proceso de scraping y predicción en <b>main_powerball.py</b> concluyó correctamente.</p>
    """
...
with DAG(
    ...
    catchup=False,
    tags=['dataloto', 'ml', 'powerball'],
) as dag:

    tarea_ejecutar_powerball = PythonOperator(
        task_id='ejecutar_scraping_y_prediccion_powerball',
    ...
    tarea_ejecutar_powerball >> tarea_notificar_exito
