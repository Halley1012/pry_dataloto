...
class LottoAmericaPredictor:
    ...
    def run(self):
        print("🔮 Iniciando Predictor Mejorado de Lotto America...")
        engine = get_engine()
        ...
        try:
            ...
            conn.execute(text("""
                CREATE TABLE IF NOT EXISTS predicciones_lotto_america (
            ...
            print(f"✅ Predicción de Lotto America guardada exitosamente para la fecha del próximo sorteo: {fecha_proximo_sorteo}")
