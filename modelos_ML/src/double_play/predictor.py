    ...
    def run(self):
        ...
        try:
            ...
            conn.execute(text("""
                ...
                VALUES (
                    (SELECT id FROM loterias WHERE LOWER(route) = 'double_play' OR LOWER(nombre) = 'double play' LIMIT 1),
                    'double_play',
                    :fecha,
                    :numeros,
                    :balotaroja
            ...
            print(f"✅ Predicción de Double Play guardada exitosamente en la tabla unificada para la fecha: {fecha_proximo_sorteo}")
