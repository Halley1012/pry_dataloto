    ...
    def run(self):
        ...
        try:
            ...
            conn.execute(text("""
                ...
                WHERE LOWER(loteria_route) = 'mloto' 
            ...
            conn.execute(text("""
                ...
                VALUES (
                    (SELECT id FROM loterias WHERE LOWER(route) = 'mloto' OR LOWER(nombre) = 'miloto' LIMIT 1),
                    'mloto',
                    :fecha,
                    :numeros,
                    NULL
            ...
            print(f"✅ Predicción con XGBoost guardada exitosamente en la tabla unificada para la fecha: {fecha_ultimo_sorteo}")
