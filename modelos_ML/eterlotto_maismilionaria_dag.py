...
def ejecutar_maismilionaria():
    from main_maismilionaria import main as main_maismilionaria
    main_maismilionaria()
...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG +Milionária ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver

    html = """
    <h3>Ejecución de +Milionária (Brasil) finalizada con éxito</h3>
    <p>El proceso de scraping, predicción y notificaciones en <b>main_maismilionaria.py</b> concluyó correctamente.</p>
    """
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - +Milionária</h3>
...
with DAG(
    ...
    tarea_ejecutar_maismilionaria = PythonOperator(
        task_id='ejecutar_scraping_y_prediccion_maismilionaria',
        python_callable=ejecutar_maismilionaria
    )
    ...
    tarea_ejecutar_maismilionaria >> tarea_notificar_exito
