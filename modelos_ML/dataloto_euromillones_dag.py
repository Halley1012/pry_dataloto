...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG Euromillones ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - Euromillones</h3>
...
with DAG(
    'dataloto_ejecucion_euromillones',
    ...
    catchup=False,
    tags=['dataloto', 'euromillones', 'spain', 'ml']
) as dag:
