...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG El Gordo de la Primitiva ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - El Gordo de la Primitiva</h3>
...
with DAG(
    ...
    catchup=False,
    tags=['dataloto', 'el_gordo', 'spain', 'ml']
) as dag:
