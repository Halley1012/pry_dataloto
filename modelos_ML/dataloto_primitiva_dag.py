...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG La Primitiva ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - La Primitiva</h3>
...
with DAG(
    ...
    catchup=False,
    tags=['dataloto', 'primitiva', 'spain', 'ml']
) as dag:
