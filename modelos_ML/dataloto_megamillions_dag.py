...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG Mega Millions ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver
...
with DAG(
    'dataloto_ejecucion_megamillions',
    default_args=default_args,
    description='Ejecuta scraping y predicción de Mega Millions usando main_megamillions.py',
    schedule='0 3 * * 2,5', # Martes y Viernes a las 3:00 AM
    start_date=datetime(2023, 1, 1),
    catchup=False,
    tags=['dataloto', 'ml', 'megamillions'],
) as dag:
