...
def validar_quina():
    print("==================================================")
    print("Iniciando Validación Histórica para Quina (Brasil)")
    print("Lotería ID: 20 | 5 balotas (1..80)")
    print("==================================================")
    ...
    with engine.connect() as conn:
        df = pd.read_sql(text("SELECT * FROM resultados_quina ORDER BY concurso ASC;"), conn)

    if df.empty:
        print("❌ Error: resultados_quina está vacía.")
        sys.exit(1)
    ...
    if errores_rango > 0 or errores_unicos > 0:
        ...
        print("✅ Todas las balotas están en rango [1..80] con 5 números únicos por sorteo")
    ...
    try:
        ...
        r = requests.get("https://servicebus2.caixa.gov.br/portaldeloterias/api/quina", headers=headers, timeout=10)
    ...
    print("\n==================================================")
    print("✅ Validación de Quina completada exitosamente!")
    print("==================================================")
