...
def ejecutar_quina():
    from main_quina import main as main_quina
    main_quina()
...
def enviar_notificacion_exito():
    ...
    msg["Subject"] = "DAG Quina ejecutado exitosamente"
    msg["From"] = sender
    msg["To"] = receiver

    html = """
    <h3>Ejecución de Quina (Brasil) finalizada con éxito</h3>
    <p>El proceso de scraping, predicción y notificaciones en <b>main_quina.py</b> concluyó correctamente.</p>
    """
...
def enviar_notificacion_error(context):
    ...
    html = f"""
    <h3>⚠️ Alerta de Ejecución en Airflow - Quina</h3>
...
with DAG(
    ...
    tarea_ejecutar_quina = PythonOperator(
        task_id='ejecutar_scraping_y_prediccion_quina',
        python_callable=ejecutar_quina
    )
    ...
    tarea_ejecutar_quina >> tarea_notificar_exito
