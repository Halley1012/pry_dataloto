...
APP_BASE_URL = os.getenv("APP_BASE_URL", "https://eterlotto-api-dev.onrender.com")
CORS_ORIGINS = [os.getenv("FRONTEND_URL", "http://localhost:3000"), "https://eterlotto-api-dev.onrender.com"]
