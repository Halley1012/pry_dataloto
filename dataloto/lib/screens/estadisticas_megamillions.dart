...
class _EstadisticasMegaMillionsScreenState extends State<EstadisticasMegaMillionsScreen> {
  ...
  static const String routeName = "megamillions";
  static const int maxBalota = 70;
  static const int maxRoja = 25;
    ...
    return AppContainer3(
      child: Row(
        ...
        children: [
          ...
          _buildMetricStat(l10n?.megaBall ?? "Mega Ball", "1 - $maxRoja"),
        ],
      ),
    );
  }
  ...
  Widget _buildCardSumaCombinaciones(List<Map<String, dynamic>> resultados, AppLocalizations? l10n) {
    ...
    final avgSuma = sumas.isEmpty ? "160" : (sumas.reduce((a, b) => a + b) / sumas.length).toStringAsFixed(0);
