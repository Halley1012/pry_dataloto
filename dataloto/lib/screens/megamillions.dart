...
class _MegaMillionsScreenState extends State<MegaMillionsScreen> with TickerProviderStateMixin {
  ...
  Future<void> _guardarJugada() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("✅ ¡Jugada de Mega Millions guardada exitosamente!")));
      _loadJugadas();
    } catch (e) {
                    ...
                    AppContainer3(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          Text("Mega Ball (Roja)", style: AppTextStyles.h2.copyWith(fontSize: 20)),
                          const SizedBox(height: 10),
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text("Últimos 5 resultados Mega Millions", style: AppTextStyles.h2),
