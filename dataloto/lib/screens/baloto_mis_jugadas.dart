...
class BalotoMisJugadasScreen extends StatefulWidget {
  ...
  @override
  State<BalotoMisJugadasScreen> createState() => _BalotoMisJugadasScreenState();
}

class _BalotoMisJugadasScreenState extends State<BalotoMisJugadasScreen> {
  ...
  Future<void> _eliminarSeleccionadas() async {
    ...
    for (final id in _selectedIds.toList()) {
      try {
        if (_userId != null) {
          await ApiService.borrarJugadaBloto(id, _userId!);
        }
      } catch (e) {
