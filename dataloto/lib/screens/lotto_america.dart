...
class _LottoAmericaScreenState extends State<LottoAmericaScreen>
  ...
  Future<void> _cargarOptimizado() async {
    ...
    try {
      ...
      debugPrint("❌ Error al cargar Lotto America en paralelo: $e");
    } finally {
  ...
  Future<void> _fetchUltimosResultados() async {
    ...
    try {
      ...
      debugPrint("Excepción al consultar últimos resultados Lotto America: $e");
    }
  }
  ...
  Future<void> fetchNumeros() async {
    ...
    try {
      ...
      debugPrint("Error al consultar predicciones Lotto America: $e");
    }
  }
  ...
  Future<void> _guardarJugada() async {
    ...
    if (seleccionados.length != maxSeleccion || balotaRojaSeleccionada == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Debes seleccionar 5 números y 1 Star Ball")),
      );
      return;
    }
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, '/estadisticas_lotto_america');
                                  },
                                  style: ElevatedButton.styleFrom(
                                    minimumSize: const Size(double.infinity, 40),
                                    backgroundColor: AppColors.yellow,
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Historial más reciente de Lotto America",
