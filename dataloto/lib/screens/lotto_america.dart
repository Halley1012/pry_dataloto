...
class _LottoAmericaScreenState extends State<LottoAmericaScreen> with TickerProviderStateMixin {
  ...
  Future<void> _guardarJugada() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("✅ ¡Jugada de Lotto America guardada exitosamente!")));
      _loadJugadas();
    } catch (e) {
                    ...
                    AppContainer3(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          Text("Star Ball (Roja)", style: AppTextStyles.h2.copyWith(fontSize: 20)),
                          const SizedBox(height: 10),
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text("Últimos 5 resultados Lotto America", style: AppTextStyles.h2),
