...
class _EstadisticasLottoAmericaScreenState extends State<EstadisticasLottoAmericaScreen> {
  ...
  static const String routeName = "lotto_america";
  static const int maxBalota = 52;
  static const int maxRoja = 10;
    ...
    return AppContainer3(
      child: Row(
        ...
        children: [
          ...
          _buildMetricStat(l10n?.starBall ?? "Star Ball", "1 - $maxRoja"),
        ],
      ),
    );
  }
  ...
  Widget _buildCardSumaCombinaciones(List<Map<String, dynamic>> resultados, AppLocalizations? l10n) {
    ...
    final avgSuma = sumas.isEmpty ? "130" : (sumas.reduce((a, b) => a + b) / sumas.length).toStringAsFixed(0);
