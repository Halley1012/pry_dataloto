...
class _DoublePlayScreenState extends State<DoublePlayScreen>
  ...
  Future<void> _cargarOptimizado() async {
    ...
    try {
      ...
      debugPrint("❌ Error al cargar Double Play en paralelo: $e");
    } finally {
  ...
  Future<void> _fetchUltimosResultados() async {
    ...
    try {
      ...
      debugPrint("Excepción al consultar últimos resultados Double Play: $e");
    }
  }
  ...
  Future<void> fetchNumeros() async {
    ...
    try {
      ...
      debugPrint("Error al consultar predicciones Double Play: $e");
    }
  }
  ...
  Future<void> _guardarJugada() async {
    ...
    if (seleccionados.length != maxSeleccion || balotaRojaSeleccionada == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Debes seleccionar 5 números y 1 Powerball")),
      );
      return;
    }
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, '/estadisticas_double_play');
                                  },
                                  style: ElevatedButton.styleFrom(
                                    minimumSize: const Size(double.infinity, 40),
                                    backgroundColor: AppColors.yellow,
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Historial más reciente de Double Play",
