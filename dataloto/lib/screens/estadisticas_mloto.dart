  ...
  Widget _buildFiltrosBarra() {
    return AppContainer3(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Filtros de Análisis (MiLoto)", style: AppTextStyles.h2),
    ...
    return AppContainer3(
      child: Row(
        ...
        children: [
          ...
          _buildMetricStat("Combinación", "5 Números"),
        ],
      ),
    );
  }
  ...
  Widget _buildCardGraficaFrecuencia(List<Map<String, dynamic>> resultados) {
    ...
    return AppContainer3(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("1. Frecuencia Histórica (Balotas 1 - 39)", style: AppTextStyles.h2),
          const SizedBox(height: 8),
    ...
    return AppContainer3(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text("Balotas de MiLoto con mayor tiempo sin aparecer:", style: AppTextStyles.caption),
          const SizedBox(height: 12),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
  ...
  Widget _buildCardBajosAltos(List<Map<String, dynamic>> resultados) {
    ...
    return AppContainer3(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("5. Bajos (1-20) vs Altos (21-39)", style: AppTextStyles.h2),
          const SizedBox(height: 16),
          Row(
            children: [
              SizedBox(
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildLegendItem("Bajos (1-20): $bajos ($pctBajos%)", Colors.cyanAccent),
                    const SizedBox(height: 8),
                    _buildLegendItem("Altos (21-39): $altos ($pctAltos%)", Colors.purpleAccent),
                  ],
                ),
              ),
            ],
    ...
    return AppContainer3(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text("Índice de afinidad estadística MiLoto:", style: AppTextStyles.caption),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(
          ...
          const SizedBox(height: 8),
          Text("✅ Alta frecuencia en rango medio-alto y equilibrio par/impar optimizado.",
