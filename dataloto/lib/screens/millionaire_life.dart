...
class _MillionaireLifeScreenState extends State<MillionaireLifeScreen>
  ...
  Future<void> _cargarOptimizado() async {
    ...
    try {
      ...
      debugPrint("❌ Error al cargar Millionaire for Life en paralelo: $e");
    } finally {
  ...
  Future<void> _fetchUltimosResultados() async {
    ...
    try {
      ...
      debugPrint("Excepción al consultar últimos resultados Millionaire for Life: $e");
    }
  }
  ...
  Future<void> fetchNumeros() async {
    ...
    try {
      ...
      debugPrint("Error al consultar predicciones Millionaire for Life: $e");
    }
  }
  ...
  Future<void> _guardarJugada() async {
    ...
    if (seleccionados.length != maxSeleccion || balotaRojaSeleccionada == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Debes seleccionar 5 números y 1 Cash Ball")),
      );
      return;
    }
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, '/estadisticas_millionaire_life');
                                  },
                                  style: ElevatedButton.styleFrom(
                                    minimumSize: const Size(double.infinity, 40),
                                    backgroundColor: AppColors.yellow,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "Últimos 5 resultados Millionaire for Life",
                                        style: AppTextStyles.h2.copyWith(fontSize: 16),
                                      ),
                                      const SizedBox(height: 2),
                                      Text(
                                        "Historial más reciente de Millionaire for Life",
