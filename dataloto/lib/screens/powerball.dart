      ...
      children: [
        Column(
          ...
          children: [
            Row(
              children: [
                const LotteryAvatar3D(nombre: "Powerball", size: 32),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(_jackpot ?? "\$180", style: AppTextStyles.h2.copyWith(color: AppColors.yellow, fontWeight: FontWeight.bold, fontSize: 15)),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Powerball Roja", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
          const SizedBox(height: 4),
