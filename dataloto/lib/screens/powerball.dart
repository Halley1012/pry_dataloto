...
class _PowerballScreenState extends State<PowerballScreen>
  ...
  Future<void> _cargarOptimizado() async {
    ...
    try {
      ...
      debugPrint("❌ Error al cargar Powerball en paralelo: $e");
    } finally {
  ...
  Future<void> _fetchUltimosResultados() async {
    ...
    try {
      ...
      debugPrint("Excepción al consultar últimos resultados Powerball: $e");
    }
  }
  ...
  Future<void> fetchNumeros() async {
    ...
    try {
      ...
      debugPrint("Error al consultar predicciones Powerball: $e");
    }
  }
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, '/estadisticas_powerball');
                                  },
                                  style: ElevatedButton.styleFrom(
                                    minimumSize: const Size(double.infinity, 40),
                                    backgroundColor: AppColors.yellow,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "Últimos 5 resultados Powerball",
                                        style: AppTextStyles.h2.copyWith(fontSize: 16),
                                      ),
                                      const SizedBox(height: 2),
                                      Text(
                                        "Historial más reciente de Powerball",
