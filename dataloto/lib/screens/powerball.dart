...
class _PowerballScreenState extends State<PowerballScreen> with TickerProviderStateMixin {
  ...
  Future<void> _cargarDatos() async {
    ...
    try {
      ...
      debugPrint("❌ Error cargando Powerball: $e");
    } finally {
  ...
  Future<void> _fetchPrediccion() async {
    try {
      ...
      debugPrint("❌ Error al obtener predicción de Powerball: $e");
    }
  }
  ...
  Future<void> _guardarJugada() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('✅ ¡Jugada de Powerball guardada exitosamente!')),
      );
      _fetchJugadas();
    } catch (e) {
      if (!mounted) return;
